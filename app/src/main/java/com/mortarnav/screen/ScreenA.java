...
//
///**
// * Navigator.get().push(Paths.screenA("toto"))
// *
// * ScreenAPath -> create
// *
// *
...
// */
//public class ScreenA implements ScreenScope {
//
//    @Override
...
//        return new Services().with(DaggerService.SERVICE_NAME, DaggerScreenA_Component.builder()
...
//
//        public void click() {
//            Navigator.get(getView()).push(new ScreenB("Hello Lukasz"));
//        }
//

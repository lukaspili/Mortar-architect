...
public abstract class AbstractProcessing<T extends AbstractSpec> {
    ...
    protected final architect.processor.Errors errors;
    protected final List<T> specs;

    public AbstractProcessing(Elements elements, Types types, architect.processor.Errors errors) {
    ...
    public abstract boolean processElement(Element element, architect.processor.Errors.ElementErrors elementErrors);

    public abstract architect.processor.AbstractComposer<T> createComposer();
}

...
/**
 * Copy past from https://github.com/android/platform_frameworks_support/blob/master/v4/java/android/support/v4/util/SimpleArrayMap.java
 * Removed the references of ArrayMap
 * Rename ContainerHelpers to SimpleArrayMapHelpers
 *
...
class SimpleArrayMap<K, V> {
    ...
    int indexOf(Object key, int hash) {
        ...
        int index = SimpleArrayMapHelpers.binarySearch(mHashes, N, hash);
    ...
    int indexOfNull() {
        ...
        int index = SimpleArrayMapHelpers.binarySearch(mHashes, N, 0);
    ...
    public SimpleArrayMap() {
        mHashes = SimpleArrayMapHelpers.EMPTY_INTS;
        mArray = SimpleArrayMapHelpers.EMPTY_OBJECTS;
        mSize = 0;
    }
